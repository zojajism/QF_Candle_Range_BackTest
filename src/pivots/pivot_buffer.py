...
class Pivot:
    ...
    price: Decimal       # high for peaks, low for lows
    is_hit: bool = False
    hit_distance: Optional[int] = None     # <<< ADDED FIELD
    type2: Optional[str] = None  # e.g. "HH", "LL", "LH", "HL" (optional, for more detailed classification)
    close_inBands: Optional[bool] = False  # e.g. for Keltner Bands (optional)
